...
//        }
        ...
        //map при условии может поменять поток, не принимает Predicate(как filter), сосредоточен на получение значений, но не результирующий
        //map для работы с каждым элементом, в нём же можно задать условие по фильтрации а потом собрать поток
